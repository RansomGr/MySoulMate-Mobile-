...
import Views.Events.EventsListerView;
...
public class MainFrameView extends com.codename1.ui.Form {
    ...
    tb.addMaterialCommandToSideMenu("Evènements", FontImage.MATERIAL_WEB, e -> {MyApplication.setCurrentView(this.renderTerminalView(EventsListerView.class));/*EventsLister c = new EventsLister(MyApplication.getTheme()); c.show();*/});
